...
export interface User {
  ...
  created_at: string;
  /** Set when user requests account deletion. Null = active account. */
  deleted_at: string | null;
  /** Set after 30-day grace period expires and PII is scrubbed. */
...
export type UserInsert       = Omit<User, 'id' | 'created_at' | 'deleted_at' | 'anonymized_at'> & Partial<Pick<User, 'id' | 'created_at' | 'deleted_at' | 'anonymized_at'>>;
